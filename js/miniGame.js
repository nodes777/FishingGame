...
TopDownGame.miniGame.prototype = {
  ...
  create: function(fishOnLine) {
    ...
    this.fishMouth = this.game.add.sprite(Phaser.Camera.width, this.game.rnd.integerInRange(100, 300), 'fishMouth');
  ...
  update: function() {
        ...
        //collisions
        this.game.physics.arcade.collide(this.hook, this.blockedLayer);
